...
<c:set var="pageSection" value="organiser-create-job"/>
                ...
                <form method="post" action="${formAction}" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="invalid-feedback">Hours per week must be greater than zero.</div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="invalid-feedback">Assistant quota must be greater than zero.</div>
