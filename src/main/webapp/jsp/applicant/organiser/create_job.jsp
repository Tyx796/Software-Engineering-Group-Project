    ...
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/organiser/jobs/create" class="needs-validation" novalidate>
                    <div class="mb-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" type="date" name="deadline" min="${today}" required value="${param.deadline}">
                        </div>
                    </div>
