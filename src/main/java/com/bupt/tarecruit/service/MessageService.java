...
/**
 * Manages system messages generated by recruitment workflow events.
 *
 * <p>Messages are stored for a recipient, can be linked to a job or application,
 * and are shown in role-specific message inboxes.</p>
 */
public class MessageService {
    ...
    /**
     * Persists a workflow message for a recipient.
     */
